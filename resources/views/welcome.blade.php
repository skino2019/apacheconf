        ...
        <div class="grid flex-grow w-1/3 h-auto card bg-base-200 rounded-box place-items-start p-4">
            ...
            <div class="card-body">
                ...
                <div class="form-control pt-8">
                    ...
                    <input type="text" placeholder="john@doe.com" class="input input-secondary input-bordered mb-3.5">

                    {{-- Server Name --}}
                    <label class="label">
                        <span class="label-text">ServerName</span>
                    </label>
                    <input type="text" placeholder="yoursite.com" class="input input-secondary input-bordered mb-3.5">
                    ...
                    <input type="text" placeholder="/var/www/yoursite/public --- Add modal here for more info"
                        class="input input-secondary input-bordered mb-3.5">
                    ...
                    <input type="text" placeholder="/usr/local/share/ca-certificates/yoursite_domain.cert.pem"
                        class="input input-secondary input-bordered ">

                    <label class="label">
                        <span class="label-text">SSLCertificateKeyFile</span>
                    </label>
                    <input type="text" placeholder="/usr/local/share/ca-certificates/yoursite_private.key.pem"
                        class="input input-secondary input-bordered">

                    <label class="label">
                        <span class="label-text">SSLCertificateChainFile</span>
                    </label>
                    <input type="text" placeholder="/usr/local/share/ca-certificates/yoursite_intermediate.cert.pem"
                        class="input input-secondary input-bordered">
                </div>
        ...
        <div class="grid flex-grow w-2/3 card bg-base-200 rounded-box place-items-start ml-4">
            <pre>
                ...
                &lt;VirtualHost *:443&gt;
                        ...
                        ServerName fujirecipe.dev
                        ServerAlias www.fujirecipe.dev

                        DocumentRoot /var/www/landing/public

                            &lt;Directory /var/www/landing/public&gt;
                    ...
                    SSLCertificateFile /usr/local/share/ca-certificates/domain.cert.pem
                    SSLCertificateKeyFile /usr/local/share/ca-certificates/private.key.pem
                    SSLCertificateChainFile /usr/local/share/ca-certificates/intermediate.cert.pem
